...
class LibraryMutation(graphene.Mutation):
    ...
    @classmethod
    def mutate(cls, root, info, id, name, about):
        try:
            ...
            return LibraryMutation(library=library)
        except Library.DoesNotExist:
            return None


class Mutation(graphene.ObjectType):
    update_library = LibraryMutation.Field()

schema = graphene.Schema(query=Query, mutation=Mutation)


# mutation first{
#   updateLibrary(id: 6, name: "New Library update", about: "New Library about update") {
#     library {
#       id
#       name
#       about
